                ...
                <div className='row'>
                    <div className='col'>
                        ...
                        <div>
                                ...
                                />
                                <select className='buscador' value={sortKey} onChange={(e) => setSortKey(e.target.value)}>
                                    <option value="producto">Producto</option>
                                    <option value="existencia">Existencia</option>
                                    <option value="transaccion">Transacción</option>
                                    {/* Agrega más opciones de ordenamiento si es necesario */}
                                </select>
                                <button className='btn btn-secondary buscador ascdes' onClick={() => setSortOrder(sortOrder === 'asc' ? 'desc' : 'asc')}>
